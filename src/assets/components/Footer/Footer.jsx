        ...
        <div className='sm:flex items-center justify-between md:gap-8'>
          ...
          <div className='w-full sm:w-1/2'>
            ...
            <div className='flex items-center gap-4 flex-wrap md:gap-8'>
              ...
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://github.com/satish141r' className='text-gray-300 font-[500] text-[25px]'><i class='ri-github-line'></i></a>
              </span>
              <span className='w-[40px] h-[40px]  mt-8 bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'>
                <a href='https://www.linkedin.com/in/satish-raibagi-163823224/' className='text-gray-300 font-[500] text-[25px]'><i class='ri-linkedin-box-fill'></i></a>
              </span>
            </div>
          </div>
        </div>
            ...
            <div className='hidden sm:block'>
              <div className='flex items-center gap-[10px]'>
                ...
                <div className='leading-[20px]'>
                  <h2 className='text-xl text-white font-[700]'>Satish Raibagi</h2>
                </div>
              </div>
            </div>
            <div>
              <p className='text-gray-400 text-[14px]'>Copyright &copy; {year} <br /><b>Satish Raibagi</b> </p>
            </div>
          </div>
        </div>
      </div>
