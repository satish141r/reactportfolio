...
const Hero = () => {
    const [title, setTitle]= React.useState("Satish Raibagi");
    React.useEffect(()=>{
            ...
            <div className='container pt-14'>
                <div className='md:flex items-center justify-between sm:flex-col md:flex-row'>
                    ...
                    <div className='w-full md:basis-1/2'>
                        ...
                        <h1 data-aos='fade-left' data-aos-duration='1500' className='text-headingColor font-[800]
                        text-[1.8rem] sm-text[40px] leading-[35px] sm:leading-[46px] mt-5'>I'm Satish <br /> A CS Engineering Graduate
                        </h1>
             ...
             py-2 px-4 rounded-[8px] max-h-[40px] hover:bg-smallTextColor ease-in duration-100'><i class='ri-mall-line'></i>Hire Me</button></a>
                            ...
                            <a href='#portfolio' className='text-smallTextColor font-[600] text-[16px] border-b border-solid border-smallTextColor'>See Projects</a>
                        </div>
                        ...
                        <div className='flex items-center gap-9 mt-14'>
                            ...
                            <span><a  title='github' target='_blank' href='https://github.com/satish141r' className='text-smallTextColor text-[25px] font-[600]'><i class='ri-github-line'></i></a></span>
                            <span><a title='LinkedIn' target='_blank' href='https://www.linkedin.com/in/satish-raibagi-163823224/' className='text-smallTextColor text-[25px] font-[600]'><i class='ri-linkedin-box-fill'></i></a></span>
                        </div>
                    </div>
                    {/* hero left end */}
